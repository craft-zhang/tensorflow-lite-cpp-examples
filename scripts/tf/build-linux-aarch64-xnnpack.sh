...
set -e
rm -rf build_tflite_2_11_1_ARM_XNNPACK
mkdir -p build_tflite_2_11_1_ARM_XNNPACK

CMAKE_ARGS=()

# CMake-level configuration
CMAKE_ARGS+=("-DCMAKE_MAKE_PROGRAM=make")
CMAKE_ARGS+=("-DCMAKE_TOOLCHAIN_FILE=$(pwd)/scripts/tf/cmake/aarch64-linux-gnu.toolchain.cmake")
...
pushd build_tflite_2_11_1_ARM_XNNPACK
