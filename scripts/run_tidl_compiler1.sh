...
#   The operators after the specified output tensor will remain as tensorflow lite operators (to be executed on Arm).
#   The beginning subgraph is represented as a single tensorflow lite custom operator (tidl-am5-custom-op) (for TIDL offload).
...
echo "outScaleF2Q = 42.5" >> $subgraph0_cfg_path
